...
public class ContactController {
    ...
    public ResponseEntity<Object> create(@RequestBody @Valid Contact contact) {
        try {
    ...
    @GetMapping("/search/{q}")
    @RequestMapping(value = "/search/{q}", method = RequestMethod.GET, produces = "application/json")
    ...
    public ResponseEntity<Object> search(@PathVariable String q) {
        try {
